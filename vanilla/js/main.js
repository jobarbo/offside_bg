...
// Load all shaders asynchronously
async function init() {
	// Load all shader files
	const [vertexShader, fragmentShader, blurVertexShader, horizontalBlurShader, verticalBlurShader, monochromeShader, animatedTextureShader] = await Promise.all([
		loadShader("./shaders/vertex.glsl"),
		loadShader("./shaders/fragment.glsl"),
		loadShader("./shaders/blurVertex.glsl"),
		loadShader("./shaders/horizontalBlur.glsl"),
		loadShader("./shaders/verticalBlur.glsl"),
		loadShader("./shaders/monochrome.glsl"),
		loadShader("./shaders/animatedTexture.glsl"),
	]);
...
init().catch((e) => console.error("Error initializing application:", e));
